...
const Contact = () => {
  return (
    <>
      <MetaData title="Liên hệ chúng tôi" />
      <Header />
      ...
      >
        ...
        >
          ...
          <strong>
            Email: <span><a style={{ color: "black" }} href="mailto:hanhchinhtonghop@humg.edu.vn">hanhchinhtonghop@humg.edu.vn</a></span>
          </strong>
        </div>
        ...
        >
          ...
          <strong>
            Địa chỉ : <span>Số 18 Phố Viên - Phường Đức Thắng - Q. Bắc Từ Liêm - Hà Nội</span>
          </strong>
        </div>
        <p style={{
          padding: "10px 0",
          fontSize: "1.3vmax"
        }}>Tùy chọn hỗ trợ Trò chuyện trực tiếp sẽ sớm ra mắt.</p>
        <h2
          style={{
            padding: "20px 0",
            textAlign: "center"
        ...
        >
          Bạn cũng có thể tìm thấy chúng tôi từ đây:
        </h2>
        <div style={{
          justifyContent: "center",
          display: "flex"
